...
function SideBar() {
  return (
    <div className="sticky top-0 left-0 flex h-screen w-60 flex-col justify-between gap-5 overflow-y-auto bg-blue-200 p-5">
      <div>
      ...
      <ul className="">
        {navLinks.map((link) => (
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "mb-2 flex items-center gap-3 rounded-[7px] bg-[rgba(144,_19,_254,_0.2)] px-3 py-3 text-[17px] text-[#9013FE]"
